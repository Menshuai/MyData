				...
				if (d == "success") {
					...
					layer.confirm('缴费成功,你要打印凭证吗?', {
					  ...
					  btn: ['前往','不要'] //按钮
						  ...
						  //跳转到 缴费页面 FaP页面
						   window.location="/Data/JfController/findFap.action?yzbh="+yzbh+"&jfje="+jfje+"&syje="+syje+"&hjje="+hjje+"&yf="+yf+"&jf="+jf+"&time="+time;
						}, function(){
    ...
    <td width="500"><div style="width:300px; height:100px; border:1px solid #999; display:flex;">
     ...
     <td width="500"><div style="width:300px; height:100px; border:1px solid #999; display:flex;">
        ...
        <div align="center" style=" width:250px;height:150px; margin-top:25px;">
          <div  style="font-size: 22px"> 100</div>
          <div style="margin-top:5px; font-size: 18px">今日缴费11总金额</div>
        </div>
      </div></td>
