	...
	<div class="panel panel-success">
		...
		<div align="left">
           <a href="javascript:history.back(-1)">返回</a>
			...
			<hr />
			<br />
			<div style="overflow-x: hidden; overflow-y: auto; height:550px; width:65%;">
				...
				<table align="center">
					...
					<tr align="center">
						...
						<td>
							<h4>
								<textarea style="overflow-x: hidden; width:950px;height:400px;" class="form-control" name="article">${noti.article}</textarea>
							</h4>
						</td>
					</tr>
