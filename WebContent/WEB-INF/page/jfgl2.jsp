...
<body>
	<div class="warp">
		...
		<div class="top_c">
			<div class="top-menu">
				...
				<c:forEach  var="menu" items="${menuList}" varStatus="status">
					...
					<%--    <li><a target="Conframel" href="<%=basePath%>DataController/DataMe.action">首页</a></li>  --%> 
				 	    <li><a target="Conframe" href="<%=basePath%>JfController/JFfindList.action">网络缴费</a></li>
				 	    <li><a target="Conframe" href="<%=basePath%>JfController/JFfindListxx.action">网络缴费编辑</a></li>  
				 	     <%--   <li><a target="Conframe" href="<%=basePath%>JfController/JFfindListxx.action">缴费信息编辑<i class="tip-up"></i></a> 
						 <ul class="kidc">							
							<li><a target="Conframel" href="<%=basePath%>Repair/RepairMe.action">添加</a></li>
							<li><a target="Conframel" href="<%=basePath%>Repair/SqazMe.action">删除</a></li>
							<li><a target="Conframel" href="<%=basePath%>Repair/SqazMe.action">修改</a></li>
						</ul>   
					</li>    --%>
					<%-- <li><a target="Conframe" href="<%=basePath%>JfController/JFfindHistList.action">缴费信息编辑</a></li> --%>
					<li><a target="Conframe" href="<%=basePath%>JfController/JFfindHistList.action">缴费信息查询</a></li>
		...
		<div class="left_c left">
			...
			<div style="font-size: 26px;margin-left: 10px">消费用户所占比例: </div>
			 <div style="height: 50px"></div>
			<div style="font-size: 40px;margin-left: 50px">30%</div>
				<%-- <iframe scrolling="no" width="100%"   name="Conframel" id="Conframel" src="<%=basePath%>JfController/JfMe.action" frameborder="0" onload="this.height=0;var fdh=(this.Document?this.Document.body.scrollHeight:this.contentDocument.body.offsetHeight);this.height=(fdh>1700?fdh:1700)"></iframe>
			 --%>
			</div>
		</div>
		<!--左边框架结束-->
		...
		<div class="Conframe" >
			<iframe  name="Conframe" id="Conframe"  src="<%=basePath%>JfController/JFfindList.action"></iframe>
		</div>
		<!--右边框架结束-->
