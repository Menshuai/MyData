...
<body>
	<div class="panel panel-success" style="border-bottom: null;">
		<div class="panel-heading" style="background-color: white;border-bottom: 1px white; ">报修详情</div>
		<span>
		&nbsp;&nbsp;&nbsp;
			选择小区
		...
		&nbsp;&nbsp;&nbsp;
		联系电话：<input type="text" name="telephone" id="telephoneId" size=10px value="${telephone}"  />
