	...
	<div class="panel panel-success">
		...
		<div class="panel-body" >
		 <button type="button" class="btn btn-success" data-toggle="modal"
				data-target="#add" style="background-image: url('../img/secai.png');border:1px">添加</button>
			&nbsp;&nbsp;
			<button type="button" class="btn btn-success" onClick="openEditUserPage()" style="background-image: url('../img/secai.png');border:1px">修改</button>
	&nbsp;&nbsp;
	 <button type="button" class="btn btn-success" onClick="openDeletePage()" style="background-image: url('../img/secai.png');border:1px">删除</button>
	&nbsp;&nbsp;
			<hr />
			<div class="dwrapper">
	<table id="fixed_hdr2">
...
<div class="modal fade" id="add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body bg-info" style="height: 350px">
					<form class="form form-horizontal" action="InsertNotice.action" method="post">
					
							<div class="form-group" style="margin-top: 30px" >						
							<label for="title" class="col-sm-2 col-sm-offset-3 control-label" style="margin-left: 10px ;" >公告标题</label>
						<div class="col-sm-4"><input id="title"  type="text" name="title"
									class="form-control" placeholder="title"  style="width: 400px"></div>
						</div>

						<div class="form-group">						
						<label for="article" class="col-sm-2 col-sm-offset-3 control-label" style="margin-left: 10px">公告内容</label>
							<div class="col-sm-4">
							<textarea id="article" style="overflow-x: hidden;width:400px;height:180px;"
							class="form-control" name="article" placeholder="article"></textarea>
							</div>
						</div>
						<div class="form-group" style="margin-top: 20px">
							<div class="col-sm-4 col-sm-offset-5" style="margin-left: 200px">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" onClick="add()" class="btn btn-primary btn-sm" style="margin-left: 10px"  >提交</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="modal-body bg-info" style="height: 350px">
					<form class="form form-horizontal" action="updateNotice.action" method="post">
					 <input type="hidden" id="edit_id" name="id" />
						...
						<div class="form-group"  style="margin-top: 30px" >						
							<label for="edit_title" class="col-sm-2 col-sm-offset-3 control-label" style="margin-left: 10px ;">公告标题</label>
							<div class="col-sm-4">
								<input id="edit_title" type="text" name="title"
									class="form-control" placeholder="title"  style="width: 400px"/>
							</div>					
						</div>
						
							<div class="form-group">						
							<label for="edit_article" class="col-sm-2 col-sm-offset-3 control-label" style="margin-left: 10px">公告内容</label>
							<div class="col-sm-4">
								<textarea id="edit_article" name="article" placeholder="article" style="overflow-x: hidden;width:400px;height:180px;" class="form-control"></textarea>
							</div>					
							</div>
						
						<div class="form-group"  style="margin-top:20px">
							<div class="col-sm-4 col-sm-offset-5" style="margin-left:200px">
							<button type="button" onClick="edit()" class="btn btn-primary btn-sm" style="margin-left: 10px" >提交</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button type="reset" class="btn btn-primary btn-sm">重置</button>
							</div>
						</div>
