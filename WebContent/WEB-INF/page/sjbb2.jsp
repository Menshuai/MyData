...
<body>
	<div class="warp">
		...
		<div class="left_c left">
			<h1>信息列表</h1>
			  <div class="acc">
				<iframe scrolling="no" width="100%"   name="Conframel" id="Conframel" src="<%=basePath%>YhMessageCon/HomeMe.action" frameborder="0" onload="this.height=0;var fdh=(this.Document?this.Document.body.scrollHeight:this.contentDocument.body.offsetHeight);this.height=(fdh>1700?fdh:1700)"></iframe>
			</div>
		</div>
		<!--左边框架结束-->
