...
<script src="../js/jquery-1.11.1.min.js" type="text/javascript"></script> 
	...
	window.onload = function() {
        window.open("/Data/Notice/Noticelist.action","Conframe");//返回的是 noticelist.jsp页面
    }
		
	</script>

<body><!-- 左边框架小区信息列表 -->
  	<iframe scrolling="no" width="100%"   name="Conframel" id="Conframel" src="/KFGL/zz/ztree.action" 
