...
public class Yh implements Serializable {
   ...
   private int id;
	...
	private String rbAd;   //传感器
	
	private String rbType;
	
	private Integer buildNO;	//楼栋
	
	private Integer cellNO;	//单元
	...
	private Double buileArea;//面积
	
	private Double useArea;//用户面积
